...
class Main  extends React.Component {
    render() {
        ...
        return (
            <>
            <HornedBeast  imageUrl='https://images.all-free-download.com/images/graphiclarge/fresh_red_apple_stock_photo_167147.jpg'  title='Red apple' imageAlt='Red apple Image' imageTitle='Red apple' description="Red Delicious is one of the most famous American apples, and one of the most widely grown apple varieties. ... Red Delicious is a medium-sized apple, with a tall conical shape. The dark and intense crimson colour makes it the quintessential red apple, and it is has strong shelf appeal." />
        <HornedBeast  imageUrl='https://images.all-free-download.com/images/graphiclarge/two_green_apple_hd_picture_167248.jpg'  title='green apple' imageAlt='green apple Image' imageTitle='green apple' description="As green apple is a fibre rich fruit, it is beneficial for weight loss. Green apples have lower sugar levels and more minerals and antioxidants that help to shed a few pounds. ... Tip: Green apples can increase your metabolism and help you to reduce weight. If you are on a diet then green apples can be a favourite snack." />
